...
ap.add_argument("-m", "--model", required=False,default="resnet-34_kinetics.onnx",
	help="path to trained human activity recognition model")
ap.add_argument("-c", "--classes", required=False,default="action_recognition_kinetics.txt",
	help="path to class labels file")
ap.add_argument("-i", "--input", type=str, default="input_data\sample.mp4",
